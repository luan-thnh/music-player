  ...
  songs: [
    {
      ...
      path: "./audio/do_toc_2.mp3",
      image: "./img/do_toc_2.jpg",
    },
    {
      name: "Độ Đúng Đời",
      singer: "Thiện Hưng x Độ Mixi",
      path: "./audio/do_dung_doi.mp3",
      image: "./img/do_dung_doi.jpg",
    },
    {
      name: "Đi Về Nhà",
      singer: "Đen x JustaTee",
      path: "./audio/di_ve_nha.mp3",
      image: "./img/di_ve_nha.jpg",
    },
    {
      name: "Mơ Hồ",
      singer: "DJChip x Nhism",
      path: "./audio/mo_ho.mp3",
      image: "./img/mo_ho.jpg",
    },
    {
      name: "At My Worst",
      singer: "Pink Sweat$",
      path: "./audio/at_my_worst.mp3",
      image: "./img/at_my_worst.jpg",
    },
    {
      name: "Cô Gái Gu Chì",
      singer: "Soái Nhi",
      path: "./audio/co_gai_guicci.mp3",
      image: "./img/co_gai_guicci.jpg",
    },
    {
      name: "Rap Thập Cẩm",
      singer: "Tú Lee",
      path: "./audio/rap_thap_cam.mp3",
      image: "./img/rap_thap_cam.png",
    },
    {
      name: "Mơ Hồ",
      singer: "DJChip x Nhism",
